...
public class AdminFrame extends javax.swing.JFrame {
    ...
    private static final String UPLOAD_MOVIE_PANEL = "Upload movie panel";
    ...
    private void configurePanels() {
        tpContent.add(UPLOAD_MOVIE_PANEL, new UploadMoviePanel());
        tpContent.add(ADMIN_PANEL, new AdminPanel());
        tpContent.add(DRAG_AND_DROP, new DragNdrop());
    }
